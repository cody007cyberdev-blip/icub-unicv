...
if ($_POST) {
    ...
    `tbl_coordenador` (`nome`, `sexo`, `contacto`, `endereco`, `email`, `data_entrada`, `password` ,`foto`) 
    VALUES (:nome, :sexo, :contacto, :endereco, :email, :data_entrada, :password, :foto);");
    ...
    $sentence->bindParam(":password", $passwordHash);
    ...
    if ($sentence->rowCount() > 0) {
        // sucesso
        flashMessage("Coordenador $nome Registrado Com Sucesso!", "success");
    } else {
        // erro
        flashMessage("Não foi possivel registrar Coordenador!", "alert");
    }
...
<div class="container-md px-0 p-md-4 my-4">
    <h1 class="text-center mb-4">Criar Coordenador</h1>
    <div class="card w-75 mx-auto">
        <div class="card-header">
            Dados do coordenador a registrar
        </div>
        <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3 form-group  row">
                    ...
                    <div class="col-12 col-md">
                        ...
                        <input type="date" class="form-control" name="data_nascimento" id="data_nascimento"
                            aria-describedby="helpId" placeholder="Data de Nascimento" required>
                    </div>
                </div>
                <div class="mb-3 form-group row">
                    <div class="col-12 col-md">
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-success me-3">Adicionar Cordenador</button>
                    <input type="reset" class="btn btn-light" role="button" value="Cancelar" />
                </div>
            </form>
        </div>
    </div>
